...
articleView.create = function() {
  ...
  var obj = {
    title:$('#article-html').val(),
    category: $('#article-category').val(),
    author: $('#article-author').val(),
    authorUrl: $('#article-author-url').val(),
    publishedOn: $('#article-published:checked').length ? new Date() : null, // array returned if checked, empty array if unchecked so lenth of 0 which is false
    body:$('#article-html').val()
  };
